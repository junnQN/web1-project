...
<table class="table table-bordered w-auto mx-auto">
        ...
        <?php
            if($tieuChi == "NgayLap")
                ...
                FROM dondathang d, taikhoan t, tinhtrang tt WHERE d.MaTaiKhoan = t.MaTaiKhoan and d.MaTinhTrang = tt.MaTinhTrang AND d.NgayLap LIKE '%$q%'
                ORDER BY d.MaTinhTrang, d.NgayLap";
            else if($tieuChi =="KhachHang")
            {
                $sql = "SELECT d.MaDonDatHang, d.NgayLap, d.MaTinhTrang, t.TenHienThi, tt.TenTinhTrang
                FROM dondathang d, taikhoan t, tinhtrang tt WHERE d.MaTaiKhoan = t.MaTaiKhoan and d.MaTinhTrang = tt.MaTinhTrang  AND t.TenHienThi LIKE '%$q%'
                ORDER BY d.MaTinhTrang, d.NgayLap";
            }
            else{
                $sql = "SELECT d.MaDonDatHang, d.NgayLap, d.MaTinhTrang, t.TenHienThi, tt.TenTinhTrang
                FROM dondathang d, taikhoan t, tinhtrang tt WHERE d.MaTaiKhoan = t.MaTaiKhoan and d.MaTinhTrang = tt.MaTinhTrang AND tt.TenTinhTrang LIKE '%$q%'
                ORDER BY d.MaTinhTrang, d.NgayLap ";
            }
