...
<table class="table table-bordered w-auto mx-auto">
    ...
    <?php
        ...
        WHERE t.MaLoaiTaiKhoan = l.MaLoaiTaiKhoan AND t.TenHienThi LIKE '%$q%'";
        else if($tieuChi =="TenDangNhap")
        {
            $sql = "SELECT t.MaTaiKhoan, t.TenDangNhap, t.TenHienThi, t.DiaChi, t.DienThoai, t.Email, t.BiXoa, l.TenLoaiTaiKhoan 
            FROM taikhoan t, loaitaikhoan l
            WHERE t.MaLoaiTaiKhoan = l.MaLoaiTaiKhoan AND t.TenDangNhap LIKE '%$q%'";
        }
        else if($tieuChi =="diaChi")
        {
            $sql = "SELECT t.MaTaiKhoan, t.TenDangNhap, t.TenHienThi, t.DiaChi, t.DienThoai, t.Email, t.BiXoa, l.TenLoaiTaiKhoan 
            FROM taikhoan t, loaitaikhoan l
            WHERE t.MaLoaiTaiKhoan = l.MaLoaiTaiKhoan AND t.DiaChi LIKE '%$q%'";
        }
        else if($tieuChi =="email")
        {
            $sql = "SELECT t.MaTaiKhoan, t.TenDangNhap, t.TenHienThi, t.DiaChi, t.DienThoai, t.Email, t.BiXoa, l.TenLoaiTaiKhoan 
            FROM taikhoan t, loaitaikhoan l
            WHERE t.MaLoaiTaiKhoan = l.MaLoaiTaiKhoan AND t.Email LIKE '%$q%'";
        }
        else if($tieuChi =="loaitaikhoan")
        {
            $sql = "SELECT t.MaTaiKhoan, t.TenDangNhap, t.TenHienThi, t.DiaChi, t.DienThoai, t.Email, t.BiXoa, l.TenLoaiTaiKhoan 
            FROM taikhoan t, loaitaikhoan l
            WHERE t.MaLoaiTaiKhoan = l.MaLoaiTaiKhoan AND l.TenLoaiTaiKhoan LIKE '%$q%'";
        }
